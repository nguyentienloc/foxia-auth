...
export const MENU_CONFIG: MenuSection[] = [
  {
    ...
    items: [
      ...
      { key: "users", label: "Users", icon: <UserIcon />, path: "/me" },
      { key: "organizations", label: "Organizations", icon: <BuildingIcon />, path: "/organizations" },
    ],
  },
  {
    title: "Configure",
    items: [
      { key: "authentication", label: "Authentication", icon: <ShieldIcon />, path: "/auth-settings" },
      { key: "org_settings", label: "Organizations Settings", icon: <SettingsIcon />, path: "/org-settings" },
      { key: "sessions", label: "Sessions", icon: <UserIcon />, path: "/sessions" }, // Reusing UserIcon for now
      { key: "accounts", label: "Accounts Portal", icon: <GlobeIcon />, path: "/portal" },
      { key: "customizations", label: "Customizations", icon: <SettingsIcon />, path: "/customizations" },
    ],
  },
  {
    title: "Developers",
    items: [
      { key: "api_keys", label: "API Keys", icon: <KeyIcon />, path: "/api-keys" },
      { key: "paths", label: "Paths", icon: <GlobeIcon />, path: "/paths" },
      { key: "domains", label: "Domains", icon: <GlobeIcon />, path: "/domains" },
    ],
  },
  {
    title: "Applications",
    items: [
      { key: "billing", label: "Plan & Billing", icon: <CreditCardIcon />, path: "/billing" },
